  ...
  return (
    <>
      <div className="flex flex-row lg:flex-row w-full items-center justify-center gap-2 border-b border-yellower">
        <img src="https://github.com/shafeeqn/JJFGRANDFINALE/blob/main/src/app/jamia.jpg" className="w-12 h-12 lg:w-16 lg:h-16 object-cover -my-20   " />
        ...
        <div className="flex lg:hidden  flex-col  items-center justify-center p-2">
          ...
          <p className="text-center capitalize font-bold  lg:text-3xl text-brown">GRAND FINALE</p>
        </div>
      </div>
