...
export default function CategoryResult({ category }: { category: string }) {
    ...
    return (
        <div className="text-center text-xs print:m-0 p-2 py-8 bg-gradient-to-br from-pink-200 via-sky-200 to-blue-200">
           
            <div className="text-xl lg:text-3xl w-full flex flex-col md:flex-row items-center justify-center font-extrabold mb-5 text-sky-800">
                JAMIA JUNIOR FEST '25 (GRAND FINALE)
            ...
            <div className="flex items-center justify-center w-full">
                <div className="overflow-auto ">
                    <div className="flex">
                        {/* Table Header */}
                        <div className="flex flex-col min-w-[350px] text-center font-semibold bg-sky-700 text-white pl-2 py-2 border border-sky-800 text-3xl justify-center">
                    ...
                    {sortedInstitutions.map((institution, index) => (
                        ...
                        >
                            {/* Institution Name */}
                            <p className="min-w-[350px] text-left text-base font-semibold pl-2 py-2 border">
                                {institution.name}
                            </p>
                            <div className="flex">
                                {programs.map((program) => (
